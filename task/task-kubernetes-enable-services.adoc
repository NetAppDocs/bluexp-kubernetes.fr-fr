...
link:https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-kubernetes-backup-to-cloud.html["Découvrez comment protéger les données de vos clusters Kubernetes à l'aide de la sauvegarde et de la restauration BlueXP"^].
